...
export const OrgChartReducer = (
  ...
  switch (action.type) {
    ...
    case EOrgChartTypes.SET_RENDER_PEERS:
      return { ...state, renderPeers: action.payload as JSX.Element[]};
    ...
    case EOrgChartTypes.SET_CO_LEAD_USER:
      return { ...state, coLeadUser: action.payload as IUserInfo | undefined};
    default:
      return state;
  }
};